...
img_38 = Photo.create!(
  title: "Spectical",
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681533/2017-7-21/Jared/office_glasses.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_39 = Photo.create!(
  title: "Sea you later",
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681531/2017-7-21/Jared/12_sweet-ice-cream-photography.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_40 = Photo.create!(
  ...
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681531/2017-7-21/Jared/9_dmitri-popov.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_41 = Photo.create!(
  ...
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681528/2017-7-21/Jared/7_lobostudio-hamburg.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_42 = Photo.create!(
  title: "Solar Power",
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681529/2017-7-21/Jared/7_jason-blackeye.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_43 = Photo.create!(
  title: "Shapes of you",
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681528/2017-7-21/Jared/6_scott-webb.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_44 = Photo.create!(
  ...
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681530/2017-7-21/Jared/ferriswheel.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_45 = Photo.create!(
  title: "World off",
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681532/2017-7-21/Jared/minimal_headphone_sky.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_46 = Photo.create!(
  ...
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681532/2017-7-21/Jared/airplane.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_47 = Photo.create!(
  ...
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681528/2017-7-21/Jared/7_ricardo-gomez-angel-273521.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_48 = Photo.create!(
  ...
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681530/2017-7-21/Jared/9_joel-filipe.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_49 = Photo.create!(
  ...
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681533/2017-7-21/Jared/minimal_summer_kayak.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_50 = Photo.create!(
  title: "Rainbow Power",
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681534/2017-7-21/Jared/minimal_rainbow_flag.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_51 = Photo.create!(
  title: "Color Run",
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681528/2017-7-21/Jared/7_maxime-bhm.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_52 = Photo.create!(
  title: "Dive Deep",
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681531/2017-7-21/Jared/8_jakob-owens.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_53 = Photo.create!(
  title: "ARR ARR",
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681530/2017-7-21/Jared/16_walrus.jpg",
  user_id: user4.id,
  location_id: location1.id
)
...
img_54 = Photo.create!(
  title: "Sup Fam",
  image_url: "http://res.cloudinary.com/smilejl/image/upload/v1500681533/2017-7-21/Jared/19_sea_of_lion.jpg",
  user_id: user4.id,
  location_id: location1.id
)
